...
<body>
    ...
    <section class="servico-pesquisa text-center">
        ...
        <form action="pesquisar-servicos.php" method="get">
    ...
    <section class="servicos-menu">
        <div class="container">
            ...
            <?php
              include "conexao.php";
                $buscar = $_GET['buscar'];
                $resultado = $cn->query("SELECT * FROM servicos WHERE statusServ = 'at' and nomeServ LIKE '$buscar'");
            ...
            ?>
                ...
                <div class="servicos-menu-desc">
                    ...
                    <a href="order.php" class="btn btn-primary">Contatar serviço</a>
                </div></div>
                <?php } ?>
